...
IN_FILE = Path("temp/rest_questions_adversarial_mixtral_mixtral.json")
OUT_FILE = Path("temp/rest_questions_adversarial_mixtral_gemma9b.json")

NUM_ENTRIES = None
SLEEP = 0

generator = Generator("gemma2-9b")
