...
IN_FILE = Path(<path + rest_questions_adversarial_gpt4o_gpt4o.json>)
OUT_FILE = Path(<path + rest_questions_adversarial_gpt4o_<model_name>.json>)

NUM_ENTRIES = None
SLEEP = 0

generator = Generator("gemma2-9b") # any from: mixtral, llama-3.1-70b, gemma2-9b
